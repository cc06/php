...
class FRequest {
    ...
    public static function getAllParams($key = null) {
        if ($key) {
            return self::checkParam($_GET[$key]);
        }
    ...
    public static function getInt($param) {
        ...
        if (isset($_GET[$param])) {
            return intval(self::checkParam($_GET[$param]));
        } else {
            return null;
        }
    }
    ...
    public static function getString($param) {
        return self::checkParam(trim($_GET[$param]));
    }
    ...
    public static function getPostString($param) {
        return self::checkParam($_POST[$param]);
    }
    ...
    public static function getRequestInt($param) {
        return intval(self::checkParam($_REQUEST[$param]));
    }
    ...
    public static function getRequestString($param) {
        return self::checkParam($_REQUEST[$param]);
    }
    ...
    /***
     * 防止script注入，过滤参数中的请括号
     */
    public static  function checkParam($pram){
        $pram=preg_replace("/javascript/si","Javascript",$pram); //过滤script标签
        $pram = preg_replace("/<(\/?script.*?)>/si",'',$pram);
        return $pram;
    }
} 