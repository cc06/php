...
<ol class="breadcrumb">
    <li class="active">修改 {$top_menus_menu.name} 的子栏目</li>
</ol>
...
<form rel="ajax" id="add_form" method="post" action="/admin/LeftMenus/update?topid={$topid}&leftid={$leftid}" class="form-horizontal"
    ...
    <div class="form-group form-group-sm">
        ...
        <div class="col-sm-10">
            <input id="name" type="text" name="name"  value="{$left_menu.name}"
    ...
    <div class="form-group form-group-sm">
        ...
        <div class="col-sm-10">
            <input id="url" type="text" name="url"  value="{$left_menu.url}"
...
<script type="text/javascript">
    ...
    function checkFiled(){
        ...
        if($('#add_form input[name=["left"]').val()===''){
            alert("地址不能为空！");
            return false;
        }
        return true;
