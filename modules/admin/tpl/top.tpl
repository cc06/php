...
<div class="top_bar">
    ...
    <div id="top-menus">
        &nbsp; <a href="/admin?c=Main&a=left&menu=auction/list" target="left_frame">运营管理</a>
        &nbsp; <a href="/admin?c=Main&a=left&menu=user" target="left_frame">用户相关</a>
        &nbsp; <a href="/admin?c=Main&a=left&menu=topic" target="left_frame">圈子相关</a>
        &nbsp; <a href="/admin?c=Main&a=left&menu=edit" target="left_frame">统计相关</a>
        &nbsp; <a href="/admin?c=Main&a=left&menu=sys" target="left_frame">系统管理</a>
    </div>
    <div class="u_info">
        {$_F['member']['username']}，
