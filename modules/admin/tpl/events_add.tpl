...
<div class="form-horizontal">
    <div class="form-group form-group-sm">
        ...
        <div class="col-sm-10" style="float: left; width: 320px;">
            <input id="text_f" type="text" name="text_f"  value=""
    ...
    <div class="form-group form-group-sm">
        ...
        <div class="col-sm-10" style="float: left; width: 320px;">
            <textarea id="textlong_f" type="text" name="textlong_f"
                   class="form-control" reg="" tip="活动内容不能为空" style="width: 600px; height: 300px;"></textarea>
        </div>
    </div>
</div>
...
<form rel="ajax" id="add_form" method="post" action="/admin/Events/add" class="form-horizontal"
...
<div class="form-group form-group-sm">
        ...
        <div class="col-sm-10" style="float: left; width: 220px;">
            <input id="tip" type="text" name="tip" value="" class="form-control" tip="按钮文字不能为空" style="width: 200px;"/>
        </div>
    ...
    <div class="form-group form-group-sm">
        ...
        <div class="col-sm-10">
            ...
            <option value="2">打开圈子</option>
            <option value="3">打开游戏</option>
        </select>
    </div>
    </div>
    ...
    <div class="form-group form-group-sm" id="anniu2">
        ...
        <div class="col-sm-10">
            <input id="topic_id" type="text" name="topic_id" value="" class="form-control" style="width: 100px;"/>
        </div>
    </div>
    ...
    <div class="form-group form-group-sm">
        ...
        <div class="col-sm-10" style="float: left; width: 320px;">
            <input style="border: 1px solid"  id="datetimepicker" name="timeout" value=""/>
        </div>
    </div>
    <div class="form-group form-group-sm" style="margin-top: 50px">
        ...
        <div class="col-sm-10">
            ...
            <input type="hidden" name="textlong" id="textlong" value=""/>
            <input type="hidden" name="pic" id="pic" value=""/>
            <input type="hidden" name="picda" id="picda" value=""/>
