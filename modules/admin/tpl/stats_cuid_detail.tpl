...
<form role="form" class="form-inline" action="?" method="get">
    <div class="form-group form-group-sm">
        <label for="form-search-reg_type" class="sr-only ">注册来源</label>
        ...
        <select class="form-control" name="spm" id="form-search-spm">
            ...
            <option value="web" id="other">其他</option>
    ...
    <input style="border: 1px solid"  id="datetimepicker" name="date" value="{$date}"/>
    <script>
...
<script type="text/javascript">
    jQuery('#form-search-reg_type').change(function(){
        var _val = jQuery(this).find('option:selected').val();
        changeOption(_val);
    });

    function changeOption(_val){
        if( _val == 4 ){
            $("#form-search-spm option").hide();
            $("#form-search-spm option[value^='ar_']").show();
            $("#all").show();
            $("#other").show();
        }else{
            $("#form-search-spm option").show();
            $("#form-search-spm option[value^='ar_']").hide();
        }
    }

    var _val = $('#form-search-reg_type').find('option:selected').val();
    changeOption(_val);
...
<script type="text/javascript" src="/js/jquery.cityselect.js?20150612.js"></script>
