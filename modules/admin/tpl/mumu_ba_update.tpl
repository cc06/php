...
<div class="form-horizontal">
    <div class="form-group form-group-sm" id="anniu1">
        ...
        <div class="col-sm-10">
            <input id="title_f" type="text" name="title_f" value="{$mumu_ba.title}" class="form-control" style="width: 500px;"/>
        </div>
    </div>
    ...
    <div class="form-group form-group-sm">
        ...
        <div class="col-sm-10" style="float: left; width: 320px;">
            <textarea id="text_f" type="text" name="text_f"
                   class="form-control" reg="" tip="内容说明" style="width: 600px; height: 100px;">{$mumu_ba.text}</textarea>
        </div>
...
<form   method="post" enctype="multipart/form-data" id="upload_form" class="form-horizontal">
    <div class="form-group form-group-sm">
        ...
        <div class="col-sm-10" style=" margin-left:50px;float: left; width: 150px; line-height: 30px;">
            尺寸400*450
        </div>
    </div>
</form>

<form rel="ajax" id="add_form" method="post" action="/admin/MumuBa/update?id={$id}" class="form-horizontal"
      role="form" onsubmit="return checkFiled()">

    <div class="form-group form-group-sm" style="margin-top: 50px">
        <label for="" class="col-sm-2 control-label"></label>
        <div class="col-sm-10">
            <input type="hidden" name="text" id="text" value="{$mumu_ba.text}" />
            <input type="hidden" name="title" id="title" value="{$mumu_ba.title}" />
            <input type="hidden" name="pic" id="pic" value="{$mumu_ba.pic}" />
...
<script type="text/javascript">
    ...
    {if $mumu_ba.pic  neq ""}
    document.getElementById('pic_xiao').style.display="block";
    document.getElementById('pic_xiao').innerHTML='<img width="120" style="margin: 5px" height="135" src="{$mumu_ba.pic}"  class="img-rounded"/>';
    {/if}
