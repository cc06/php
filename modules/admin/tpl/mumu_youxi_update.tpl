...
<div class="form-horizontal">
    <div class="form-group form-group-sm" id="anniu1">
        ...
        <div class="col-sm-10">
            <input id="title_f" type="text" name="title_f" value="{$mumu_youxi.title}" class="form-control" style="width: 500px;"/>
        </div>
    </div>
    ...
    <div class="form-group form-group-sm">
        ...
        <div class="col-sm-10" style="float: left; width: 320px;">
            <textarea id="text_f" type="text" name="text_f"
                   class="form-control" reg="" tip="内容说明" style="width: 600px; height: 100px;">{$mumu_youxi.text}</textarea>
        </div>
...
<form rel="ajax" id="add_form" method="post" action="/admin/MumuYouxi/update?id={$id}" class="form-horizontal"
      role="form" onsubmit="return checkFiled()">

    <div class="form-group form-group-sm">
        <label for="input-title" class="col-sm-2 control-label">链接地址： </label>
        <div class="col-sm-10">
            <input id="url" type="text" name="url" value="{$mumu_youxi.url}" class="form-control" style="width: 500px;"/>
        </div>
    </div>
    ...
    <div class="form-group form-group-sm">
        ...
        <div class="col-sm-10">
            <input id="position" type="text" name="position" value="{{$mumu_youxi.position}}" class="form-control" style="width: 100px;"/>
            整数，越小越靠前
        </div>
    </div>
    <div class="form-group form-group-sm" style="margin-top: 50px">
        ...
        <div class="col-sm-10">
            <input type="hidden" name="text" id="text" value="{$mumu_youxi.text}" />
            <input type="hidden" name="title" id="title" value="{$mumu_youxi.title}" />
            <input type="hidden" name="pic" id="pic" value="{$mumu_youxi.pic}" />
...
<script type="text/javascript">
    ...
    {if $mumu_youxi.pic  neq ""}
    document.getElementById('pic_xiao').style.display="block";
    document.getElementById('pic_xiao').innerHTML='<img width="100" style="margin: 5px" height="100" src="{$mumu_youxi.pic}"  class="img-rounded"/>';
    {/if}
