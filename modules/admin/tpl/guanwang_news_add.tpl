...
<form rel="ajax" id="add_form" method="post" action="/admin/GuanwangNews/add" class="form-horizontal"
...
<div class="form-horizontal">
    <div class="form-group form-group-sm" id="anniu1">
        ...
        <div class="col-sm-10">
            <input id="title" type="text" name="title" value="" class="form-control" style="width: 500px;"/>
        </div>
    </div>
    ...
    <div class="form-group form-group-sm">
        ...
        <div class="col-sm-10" style="float: left; width: 320px;">
            <input style="border: 1px solid"  id="datetimepicker" name="riqi" value=""/>
        </div>
    </div>
</div>
    <script>
