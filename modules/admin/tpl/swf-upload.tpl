...
function challs_flash_update() { //Flash 初始化函数
    ...
    a.FormName = "file_name";
    //设置Form表单的文本域的Name属性

    a.url = "http://upload.img.yuanfenba.net/Index/upload";
    //设置服务器接收代码文件

    a.parameter = "type=photo&flag=1&uid=1000";
...
//上传成功的图片集合，当点击【清空】按钮时，将清除该集合
var uploadImageArray = [];
function challs_flash_onCompleteData(a) { //获取服务器反馈信息事件
   // document.getElementById('show').innerHTML+='<font color="#ff0000">服务器端反馈信息：</font><br />'+a+'<br />';
    var jsonObj = eval("(" + a + ")");
    if (jsonObj.status == "ok") {
        uploadImageArray.push(jsonObj.res.file_http_path);
        update_conplete(uploadImageArray);
       // document.getElementById('show').innerHTML+='<font color="#ff0000">url：</font><br />'+jsonObj.res.file_http_path+'<br />';
    }
}
...
<div style="">
    <object z-index="1" classid="clsid:d27cdb6e-ae6d-11cf-96b8-444553540000"
            codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=11,0,0,0" width="570"
            height="240" id="update" align="middle">
        <param name="allowFullScreen" value="false"/>
        <param name="wmode" value="Transparent"/>
        <param name="allowScriptAccess" value="always"/>
        <param name="movie" value="/js/cfUpload/update.swf"/>
        <param name="quality" value="high"/>
        <param name="bgcolor" value="#ffffff"/>
        <embed wmode="transparent" src="{$_F.s_url}/js/cfUpload/update.swf" quality="high" bgcolor="#ffffff" width="570" height="240"
